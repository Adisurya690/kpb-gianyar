<div style="max-width: 500px; margin: 0 auto; padding: 20px; border-radius: 10px; background-color: #ffffff; text-align: center; font-family: Arial, sans-serif; border: 1px solid #e0e0e0;">
  ...
  <!-- Header -->
  <h2 style="color: #000000; margin-bottom: 10px;">Laporan Anda Telah Diterima</h2>

  <!-- Body -->
  <p style="color: #4a4a4a; font-size: 16px; margin-bottom: 20px;">
      Halo <strong>{{ $report->reporter }}</strong>, laporan Anda mengenai kebudayaan <strong style="color: #cc0000;">{{ $report->name }}</strong> telah kami terima.
  </p>
  
  <p style="color: #4a4a4a; font-size: 14px; margin-bottom: 20px;">
      Terima kasih atas partisipasi Anda dalam melaporkan kebudayaan di Kabupaten Gianyar.
  </p>

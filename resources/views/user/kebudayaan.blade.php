  ...
  <div class="mt-6">
    <form class="flex items-center max-w-lg mx-auto" method="GET" action="{{ url()->current() }}">
      ...
      <div class="relative w-full">
        ...
        <input type="text" id="simple-search" name="search" class="bg-white border text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full ps-10 p-2.5"
